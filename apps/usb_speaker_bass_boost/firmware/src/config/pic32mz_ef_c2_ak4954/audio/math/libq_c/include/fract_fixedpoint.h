...
/* Fixed Point Integer Typedef for Q15
  ...
  Description:
    ...
    Values for this data type are in the range [-1,+1), i.e. -1 <= x < +1.
    Note this is functionally identical to fract_q0d15_t.
...
*/
typedef fract_q0d15_t   fract_q15_t;
...
*/
typedef uint16_t       fract_q0d16_t;
...
/* Fixed Point Integer Typedef for Q16
  ...
  Description:
    ...
    Values for this data type are in the range [0,+1], i.e. 0 <= x <= +1.
    Note this is functionally identical to fract_q0d16_t.
...
/* Fixed Point Integer Typedef for Q3.12
  ...
  <code>
    float Xfloat;
    fract_q0d15_t Xq3d12;

    Xfloat = Xq3d12/4096.0;
    Xq3d12 = (fract_q0d15_t)(Xfloat*4096);
  </code>
...
/* Fixed Point Integer Typedef for Q10.5
  ...
  <code>
    float Xfloat;
    fract_q10d5_t Xq10d5;

    Xfloat = Xq10d5/32.0;
    Xq10d5 = (fract_q10d5_t)(Xfloat*32);
  </code>
...
/* Fixed Point Integer Typedef for Q31
  ...
  Description:
    Typedef for the Q0.15 fixed point data type into a 32 bit signed integer.
    Values for this data type are in the range [-1,+1), i.e. -1 <= x < +1.
    Note: this typedef is functionally equivalent to fract_q0d31_t.
...
*/
typedef fract_q0d31_t   fract_q31_t;
...
/**************************************************************************
  ...
  **************************************************************************/
typedef int32_t        fract_q15d16_t;
...
/**********************************************************************
  ...
  **********************************************************************/
typedef int32_t        fract_q16d15_t;
...
<pre><c>
  ...
  ******************************************************************************/
typedef fract_q0d63_t   fract_q63_t;
...
/* Q15 Block Floating Point Typedef
  ...
  Remarks:
    Example:
  <code>
    fract_q15bfp_t x; // Original number
    fract_q0d15_t   y; // equivalent fixed point.
    if ( x.e < 0 )
...
/* Q31 Block Floating Point Typedef
  ...
  Remarks:
    Example:
  <code>
    fract_q31bfp_t x; // Original number
    fract_q0d31_t   y; // equivalent fixed point.
    if ( x.e < 0 )
    {
        if ( x.m < 0 )
        { // Right shifting negative numbers can be dangerous!
